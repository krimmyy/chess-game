...
public class Piece {
    ...
    public int getCol (int x) {
        return (x + Board.HALF_SQUARE_SIZE) / Board.HALF_SQUARE_SIZE;
    }

    public int getRow (int y) {
        return (y + Board.HALF_SQUARE_SIZE) / Board.HALF_SQUARE_SIZE;
    }
    ...
    public boolean isValidSquare(int targetCol, int targetRow) {
        ...
        // This square is OCCUPIED
            ...
            // If the color is different than current piece then it can be captured
